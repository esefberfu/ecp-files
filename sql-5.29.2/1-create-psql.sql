...
create table key_value2 (pk int8 not null, content_type varchar(255) not null, created_time timestamp not null, key_name varchar(255) not null, updated_time timestamp not null, username varchar(255), key_value varchar(4000) not null, primary key (pk));
